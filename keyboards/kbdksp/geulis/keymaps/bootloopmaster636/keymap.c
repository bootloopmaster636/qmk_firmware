...
[0] = LAYOUT_split_3x6_5t_plus(
    ...
    OSM(MOD_LCTL),KC_Z, KC_X,   KC_C,   KC_V,   KC_B, KC_MEDIA_NEXT_TRACK, KC_MEDIA_PREV_TRACK,             LCA(KC_F13), LCA(KC_F14),       KC_N,   KC_M,   TD(TD_COMMA_PLUS), TD(TD_DOT_PLUS), KC_SLASH, KC_SEMICOLON,
    KC_LGUI  ,  OSM(MOD_LALT),  OSL(2), TT(3),  KC_SPACE,                                                                           KC_ENT, OSM(MOD_LSFT),  KC_BACKSPACE,   TD(TD_BRACKETS),   KC_BACKSLASH
),
...
[1] = LAYOUT_split_3x6_5t_plus(
    ...
    OSM(MOD_LCTL),KC_Z, KC_X,   KC_C,   KC_D,   KC_V, KC_MEDIA_NEXT_TRACK, KC_MEDIA_PREV_TRACK,             LCA(KC_F13), LCA(KC_F14),       KC_K,   KC_H,   TD(TD_COMMA_PLUS), TD(TD_DOT_PLUS), KC_SLASH, KC_SEMICOLON,
    KC_LGUI  ,  OSM(MOD_LALT),  OSL(2), TT(3),  KC_SPACE,                                                                           KC_ENT, OSM(MOD_LSFT),  KC_BACKSPACE,   TD(TD_BRACKETS),   KC_BACKSLASH
),
...
[2] = LAYOUT_split_3x6_5t_plus(
    ...
    KC_TRNS  ,  KC_TRNS,        KC_TRNS,OSM(MOD_LSFT),KC_TRNS,                                                          KC_TRNS,    KC_PLUS,    KC_TRNS,    KC_0,   KC_DOT
),
...
[3] = LAYOUT_split_3x6_5t_plus(
    ...
    KC_TRNS,  OSM(MOD_LSFT),KC_NO,              QK_MOUSE_BUTTON_4,      QK_MOUSE_BUTTON_5,      KC_NO, KC_NO, KC_NO,              KC_NO, KC_NO,     QK_MOUSE_WHEEL_RIGHT,   QK_MOUSE_WHEEL_UP,  QK_MOUSE_WHEEL_DOWN,    QK_MOUSE_WHEEL_LEFT,    KC_NO, KC_NO,
    KC_NO  ,  KC_TRNS,  KC_NO,                  KC_TRNS,                KC_NO,                                                                      QK_MOUSE_BUTTON_1,      KC_NO,              KC_NO,                  KC_NO,                  KC_NO
),
