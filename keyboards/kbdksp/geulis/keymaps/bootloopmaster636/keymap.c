...
[0] = LAYOUT_split_3x6_5t_plus(
    ...
    OSM(MOD_LCTL),KC_Z, KC_X,   KC_C,   KC_V,   KC_B, KC_MEDIA_NEXT_TRACK, KC_MEDIA_PREV_TRACK,             LCA(KC_F13), LCA(KC_F14),       KC_N,   KC_M,   TD(TD_COMMA_PLUS), TD(TD_DOT_PLUS), KC_QUOTE, TD(TD_BRACKETS),
    KC_LGUI  ,  OSM(MOD_LALT),  OSL(2), OSM(MOD_LSFT),  KC_SPACE,                                                                           KC_ENT, TT(3),  KC_BACKSPACE,   KC_SLASH,   KC_BACKSLASH
),

[1] = LAYOUT_split_3x6_5t_plus(
    KC_ESCAPE,  KC_Q,   KC_W,   KC_F,   KC_P,   KC_B,                                                                                       KC_J,   KC_L,   KC_U,   KC_Y,   KC_MINS,    TD(TD_EQUAL_PLUS),
    KC_TAB   ,  KC_A,   KC_R,   KC_S,   KC_T,   KC_G, KC_MEDIA_PLAY_PAUSE,                                                  KC_MUTE,        KC_M,   KC_N,   KC_E,   KC_I,   KC_O,       KC_SEMICOLON,
    OSM(MOD_LCTL),KC_Z, KC_X,   KC_C,   KC_D,   KC_V, KC_MEDIA_NEXT_TRACK, KC_MEDIA_PREV_TRACK,             LCA(KC_F13), LCA(KC_F14),       KC_K,   KC_H,   TD(TD_COMMA_PLUS), TD(TD_DOT_PLUS), KC_QUOTE, TD(TD_BRACKETS),
    KC_LGUI  ,  OSM(MOD_LALT),  OSL(2), OSM(MOD_LSFT),  KC_SPACE,                                                                           KC_ENT, TT(3),  KC_BACKSPACE,   KC_SLASH,   KC_BACKSLASH
),
...
[2] = LAYOUT_split_3x6_5t_plus(
    KC_GRAVE ,  KC_PRINT_SCREEN,KC_F1,  KC_F2,  KC_F3,  KC_F4,                                                          KC_PPLS,    KC_7,       KC_8,       KC_9,   KC_PGUP,    KC_PGDN,
