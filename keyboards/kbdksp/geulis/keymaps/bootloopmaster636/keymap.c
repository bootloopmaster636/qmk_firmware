...
[0] = LAYOUT_split_3x6_5t_plus(
    ...
    KC_LGUI  ,  OSM(MOD_LALT),  KC_BACKSPACE, TT(2),  KC_SPACE,                                                                             OSM(MOD_LSFT),OSL(3), KC_ENTER,TD(TD_BRACKETS),KC_BACKSLASH
),
...
[3] = LAYOUT_split_3x6_5t_plus(
    ...
    KC_TRNS  ,  KC_TRNS,    KC_TRNS,KC_NO,  KC_TRNS,                                                                        KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_NO,   KC_NO
),
