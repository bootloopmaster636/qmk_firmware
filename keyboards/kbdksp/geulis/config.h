...
// Orbital mouse
#define ORBITAL_MOUSE_SPEED_CURVE {12, 34, 50, 64, 77, 89, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99}
#define ORBITAL_MOUSE_RADIUS 20
#define ORBITAL_MOUSE_SLOW_MOVE_FACTOR 0.4
#define ORBITAL_MOUSE_SLOW_TURN_FACTOR 0.5
#define ORBITAL_MOUSE_FAST_MOVE_FACTOR 2.0
#define ORBITAL_MOUSE_FAST_TURN_FACTOR 1.2
